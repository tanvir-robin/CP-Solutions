...
{   DouraMama
    ...
    while(t--) {
      ll n1,n2,n3,n4;
      cin>>n1>>n2>>n3>>n4;
      if(n1+n3==n2 && n1+n3==n4) cout<<"Yes"<<endl;
      else if(n1+n4==n3 && n1+n4==n2) cout<<"Yes"<<endl;
      else if(n2+n3==n1 && n2+n3==n4) cout<<"Yes"<<endl;
      else if(n2+n4==n1 && n2+n4==n3) cout<<"Yes"<<endl;
      else cout<<"No"<<endl;
    }
